...
def view_all_logs():
    ...
    rows = r_log.read(sql)
    return render_template("view_all_logs.html", result=rows)
...
def save_data():
    ...
    reservation_data_object = ReservationLogger(name=request.form['name'],
                                                ...
                                                date_from=int(request.form['Reservation From']),
                                                date_to=int(request.form['Reservation To']),
